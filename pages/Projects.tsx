            ...
            <Section className="scroll-mt-24 relative">
              <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-8 border-b border-slate-200 pb-8">
                ...
                <div className="flex gap-3">
                  {project.repoLink && (
                     <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href={project.repoLink} target="_blank" rel="noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-md bg-white border border-slate-300 text-sm font-medium hover:border-indigo-600 hover:text-indigo-600 transition-colors shadow-sm group">
                       <Github size={16} /> 
                       <span>Code</span>
                     </motion.a>
                  )}
                  {project.demoLink && (
                     <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href={project.demoLink} target="_blank" rel="noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-md bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-700 transition-all shadow-sm hover:shadow-indigo-500/30 group">
              ...
              <div className="grid md:grid-cols-12 gap-8">
                ...
                <div className="md:col-span-4 space-y-8">
                  <motion.div whileHover={{ x: 5 }} className="cursor-default">
                ...
                <div className="md:col-span-8 space-y-8">
                  ...
                  <motion.div whileHover={{ y: -5 }}>
                    <Card className="bg-slate-50/50 border-slate-200 hover:bg-white hover:border-indigo-500 hover:shadow-xl hover:shadow-indigo-500/10 transition-all duration-300 group cursor-default h-full">
                      ...
                      <ul className="space-y-3">
                        {project.caseStudy.benefits.map((benefit, i) => (
                  ...
                  {/* Outcome - Interactive Grid */}
                  <div className="grid sm:grid-cols-2 gap-6">
                    <motion.div whileHover={{ scale: 1.02 }} className="bg-emerald-50/50 border border-emerald-100 p-5 rounded-lg shadow-sm hover:shadow-md hover:border-emerald-400 transition-all duration-300 cursor-default">
                  ...
                  <motion.div whileHover={{ scale: 1.01 }} className="relative overflow-hidden bg-slate-900 p-6 rounded-lg shadow-lg border border-slate-800 group hover:shadow-indigo-500/30 hover:border-indigo-400 transition-all duration-300 cursor-default">
                      ...
                      <h4 className="relative z-10 text-indigo-400 font-bold text-sm uppercase tracking-wider mb-3 flex items-center gap-2">
                           <Sparkles size={14} className="text-indigo-300" /> Key Takeaway
                      </h4>
